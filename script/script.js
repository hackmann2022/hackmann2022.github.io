...
formSubmit = function(e) {
    ...
    statusMessageSuccessText = 'Thanks for signing up for HackMANN 2022! Look out soon for an email from us for more details.';
    if (formName === 'sponsor') {
        statusMessageSuccessText = 'Thanks for your interest in sponsoring HackMANN 2022! Feel free to email us; otherwise, we will get in touch with you as soon as possible.';
    }
